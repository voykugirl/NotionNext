...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '7a6267c0940a45ddb11cd6cb9b5a4262',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'smithao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个大神', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.336899.xyz', // 网站地址
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '一个小站', // 站点描述，被notion中的页面描述覆盖
